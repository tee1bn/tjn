    ...
    send_verification_email();
				...
				<div class="card-content">	
					<div class="card-body" style="padding-top: 0px;">
 					Hi <b><?=$auth->firstname;?>,</b><br><br>
						<p>
  						

						We have sent you a confirmation email. Kindly check your inbox/promotion/spam/social.</p>
                          <form action="<?=domain;?>/register/verify_email" method="POST" class="ajax_form">
                            
                          <button  type="submit" class="btn btn-dark  btn-block">Resend</button>
                          </form>
