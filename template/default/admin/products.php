                        ...
                        <div class="list-group">
                            <div class="list-group-item  ">
                                <div class="d-flex w-100 justify-content-between">
                                    <h5 class="text-bold-600"><a href="<?=$product->AdminEditLink;?>" title="Edit <?=$product->name;?>">
                                       <?=$product->name;?></a> 
                                   ...
                                   <small>
                                      ...
                                      <div class="dropdown-menu">
                                          ...
                                          <a class="dropdown-item" href="<?=$product->AdminEditLink;?>">Edit</a>
                                          <!-- <a class="dropdown-item" href="#">Link 3</a> -->
                                      </div>
                                  </div>
                              </small> </div>
                              <p><?=$product->ShortDescription;?></p>
                              <small><?=$product->currency;?><?=$product->price;?></small><br>
                              <small><?=$product->user->DropSelfLink;?></small>
                          </div>
                      </div>
                  <?php endforeach;?>
              </div>
