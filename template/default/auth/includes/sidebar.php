  ...
  <div class="main-menu-content">
    ...
    <!--   <li class=" nav-item"><a href="#"><i class="fa fa-sitemap"></i><span class="menu-title"
        ...
        <ul class="menu-content">
          ...
          <li><a class="menu-item" href="<?=domain;?>/user/direct-ranks">Direct Ranks</a></li>                    
...
<!-- 
 ...
 -->
      ...
      <li class=" nav-item"><a href="#"><i class="ft-clock"></i><span class="menu-title" data-i18n="">Wallet</span></a>
        <ul class="menu-content">

          <li><a class="menu-item" href="<?=domain;?>/user/my-wallet">My Wallet</a></li>
          <li><a class="menu-item" href="<?=domain;?>/user/wallet-history">Wallet History</a>
