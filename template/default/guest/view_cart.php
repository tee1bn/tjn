                        ...
                        <form id="" class="ajax_form" data-function="on_complete_order"
                         method="post" action="<?=domain;?>/shop/complete_order/get_breakdown">
                            ...
                            <div class="form-group">                               
                              <label><small>Your Full Name</small></label>
                              <input type="" name="fullname" class="form-control" ng-init="$shop.$cart.$extra_detail.fullname='<?=$auth->fullname ?? $auth->fullname;?>'"
                              ng-model="$shop.$cart.$extra_detail.fullname" value=""  required=""> 
                            </div> 
